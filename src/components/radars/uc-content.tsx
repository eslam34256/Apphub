...
/** محتوى رادار الشدات — بيشتغل كصفحة مستقلة وكتوب جوه مركز الرادارات */
export function UcRadarContent() {
          ...
          <table className="w-full min-w-[560px] text-sm">
            ...
            <tbody>
              {OFFICIAL_PACKS.map((p, i) => {
                ...
                return (
                  <tr key={p.uc} className={`border-b border-cream-100 ${isBest ? "bg-sage-50" : ""}`}>
