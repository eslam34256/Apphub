export const translations = {
  ar: {
    ...
    nav_price_index: "مؤشر الأسعار",
    nav_index: "المؤشر",
    nav_store: "المتجر",
    nav_research: "الأبحاث",
    nav_uc: "رادار الشدات",
    nav_telecom: "رادار الباقات",
    nav_ai_radar: "رادار AI",
    nav_press: "الصحافة",
    nav_disclosure: "الإفصاح والشفافية",
    nav_shop: "المتجر الرقمي",
    nav_data: "البيانات والأبحاث",
  ...
  en: {
    ...
    nav_price_index: "Price Index",
    nav_index: "Index",
    nav_store: "Store",
    nav_research: "Research",
    nav_uc: "UC Radar",
    nav_telecom: "Bundles Radar",
    nav_ai_radar: "AI Radar",
    nav_press: "Press",
    nav_disclosure: "Disclosure & Transparency",
    nav_shop: "Digital Store",
    nav_data: "Data & Research",
